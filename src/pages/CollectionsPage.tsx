                ...
                <Link to={`/categories/${cat.slug}`} style={{ display: 'block' }}>
                  <div className="collection-card"
                    style={{
                      ...
                      boxShadow: '0 4px 20px rgba(158,94,115,0.08)',
                    ...
                    onMouseEnter={e => {
                      ...
                      e.currentTarget.style.boxShadow = '0 20px 48px rgba(158,94,115,0.14)'
                    }}
                    onMouseLeave={e => {
                      e.currentTarget.style.transform = 'translateY(0)'
                      e.currentTarget.style.boxShadow = '0 4px 20px rgba(158,94,115,0.08)'
                    }}
                  >
                    {/* Image */}
                    <div className="collection-card__image" style={{
                      aspectRatio: '16/9',
                      overflow: 'hidden',
                      backgroundColor: 'rgba(244,198,168,0.14)',
                    }}>
                      {cat.image_url ? (
                        <img
                          src={cat.image_url}
                        ...
                        <div style={{
                          ...
                          <p style={{
                            fontFamily: 'Playfair Display, serif',
                            fontSize: 18, color: 'var(--ink-3)', fontStyle: 'italic',
                          }}>{cat.name}</p>
                        </div>
                      )}
                    </div>
                    ...
                    <div className="collection-card__info" style={{ padding: '20px 24px' }}>
                      <div className="collection-card__meta" style={{
                        ...
                        <div className="collection-card__arrow" style={{
                          ...
                          boxShadow: '0 4px 12px rgba(158,94,115,0.18)',
                        }}>
                          <ArrowRight size={15} color="var(--ink)" strokeWidth={2.5} />
                        </div>
                      </div>
                    </div>
                  </div>
